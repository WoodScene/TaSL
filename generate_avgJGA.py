...
def main(
    ...
    if with_replay:
        if lora_type == "vanilla":
            lora_weights = os.path.join("./checkpoint_files", "dataset_id_"+str(dataset_id)+"_with_memoryreplay", str(len(dataset_order)-1)+"-"+last_service_name)
        else:
            lora_weights = os.path.join("./checkpoint_files", "importance_dataset_id_"+str(dataset_id)+"_averaging_with_memoryreplay", str(len(dataset_order)-1)+"-"+last_service_name + "" + lora_type)
    else:
        if lora_type == "vanilla":
            lora_weights = os.path.join("./checkpoint_files", "dataset_id_"+str(dataset_id), str(len(dataset_order)-1)+"-"+last_service_name)
        else:
            lora_weights = os.path.join("./checkpoint_files", "importance_dataset_id_"+str(dataset_id)+"_averaging", str(len(dataset_order)-1)+"-"+last_service_name + "" + lora_type)
    ...
    if with_replay:
        if lora_type == "vanilla":
            output_dir = os.path.join("./output", "dataset_id_"+str(dataset_id)+"_avgJGA_with_memoryreplay")
        else:
            output_dir = os.path.join("./output", "importance_dataset_id_"+str(dataset_id)+"_avgJGA_with_memoryreplay"+ lora_type)
    else:
        if lora_type == "vanilla":
            output_dir = os.path.join("./output", "dataset_id_"+str(dataset_id)+"_avgJGA")
        else:
            output_dir = os.path.join("./output", "importance_dataset_id_"+str(dataset_id)+"_avgJGA"+ lora_type)
